    ...
    try {
        ...
        const project = await prisma.project.create({
            data: {
                ...
                end_date: end_date ? new Date(end_date) : null, // Fixed: was duplicate start_date
            }
        })
...
export const addMember = async(req, res) => {
    try {
        ...
        const project = await prisma.project.findUnique({
            where: { id: projectId },
            include: { members: { include: { user: true } } } // Fixed: was 'incldue'
        })
        ...
        // Fixed: access email via member.user.email
        ...
        const member = await prisma.projectMember.create({
            data: {
                userId: user.id, // Fixed: was undefined 'id'
                projectId
            }
        })
